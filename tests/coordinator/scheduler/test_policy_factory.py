...
class TestPolicyFactory(unittest.TestCase):
    ...
    def test_create_c2lb(self):
        """create returns a C2LBPolicy for C2LB type."""
        policy = create(SchedulerType.C2LB, MockInstanceProvider())
        self.assertIsInstance(policy, C2LBPolicy)
