...
//! published by Mgmt; per-slot `active_tokens` / `prefill_cost` / `cpu_hit_blocks` are
...
pub const ENTRY_V5_OFF_PREFILL_COST: usize = 24; // u64 (f64::to_bits), AtomicU64
