...
class RequestInfo(BaseModel):
    ...
    c2lb_debug: dict | None = Field(
        default=None,
        exclude=True,
        description="Per-endpoint (prefill_cost, cpu_hit_blocks, npu_hit) cached by the c2lb "
        "policy at selection; the worker re-ranks by ledger isl, prefers high-NPU-hit DPs that "
