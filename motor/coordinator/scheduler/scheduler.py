...
class Scheduler:
    ...
    async def _allocate_selected(
        ...
        # KV affinity only: other policies leave kv_affinity_debug unset, so this stays 0.
        workload.prefill_cost = affinity_prefill_cost(req_info, instance.id, endpoint.id)
